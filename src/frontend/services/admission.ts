...
const API_URL = (process.env.UMI_APP_API_URL || 'http://localhost:5000') + '/api/admission';
...
// ── Cutoff scores ───────────────────────────────
const CUTOFF_URL = (process.env.UMI_APP_API_URL || 'http://localhost:5000') + '/api/cutoff';
