...
-- =========================================================================
-- 2. KHỞI TẠO CÁC BẢNG HỆ THỐNG & NGƯỜI DÙNG
-- =========================================================================
CREATE TABLE roles (
...
-- =========================================================================
-- 3. KHỞI TẠO CÁC BẢNG DANH MỤC TRƯỜNG, NGÀNH, KHỐI
-- =========================================================================
...
-- =========================================================================
-- 4. KHỞI TẠO CÁC BẢNG NGHIỆP VỤ HỒ SƠ & XÉT TUYỂN
-- =========================================================================
...
-- =========================================================================
CREATE TYPE admission_status_enum AS ENUM ('draft', 'submitted', 'reviewing', 'approved', 'rejected', 'needs_revision');

CREATE TABLE admission_applications (
    id SERIAL PRIMARY KEY,
    user_id INTEGER NOT NULL UNIQUE,
    status admission_status_enum DEFAULT 'draft',
    personal_info JSONB,
    academic_info JSONB,
...
CREATE INDEX idx_potential_reviewed ON potential_students(reviewed);
CREATE INDEX idx_potential_created ON potential_students(created_at);
CREATE INDEX idx_potential_session ON potential_students(session_id);
...
CREATE INDEX idx_cutoff_year ON cutoff_scores(year);

-- Chèn dữ liệu điểm chuẩn mẫu năm 2026
